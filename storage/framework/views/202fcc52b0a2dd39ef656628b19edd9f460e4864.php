...
<div class="container text-center my-5">
        ...
        <div class="col-md-2 offset-md-5 mt-4">
            <div class="d-grid gap-2">
                <a class="btn btn-dark" href="<?php echo e(route ('home')); ?>" class="nav-link active">Home</a>
            </div>
        </div>
    </div>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/app.js'); ?>
</body>
</html><?php /**PATH C:\Users\juand\Desktop\Modul4\resources\views/welcome.blade.php ENDPATH**/ ?>